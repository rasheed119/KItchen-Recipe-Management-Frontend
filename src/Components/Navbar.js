      ...
      <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
        ...
        <List>
          ...
          { !Cookie.access_token ? 
            ...
            <ListItem disablePadding>
              <ListItemButton sx={{ textAlign: 'center' }} onClick={()=>navigate("/saved")} >
                <ListItemText>
                    Saved Recipes
                </ListItemText>
              </ListItemButton>
            ...
            <ListItem disablePadding>
              <ListItemButton sx={{ textAlign: 'center' }} onClick={()=>navigate("/recipe")} >
                <ListItemText>
                    Create Recipes
                </ListItemText>
              </ListItemButton>
        ...
        <AppBar component="nav">
          <Toolbar>
            ...
            <Button sx={{ color: '#fff' }} onClick={()=>navigate("/")} >
                ...
                <Button sx={{ color: '#fff' }} onClick={()=>navigate("/recipe")} >
                 Create Recipes
                </Button>
                ...
                :
                <Button sx={{ color: '#fff' }} onClick={()=>navigate("/auth")} >
                Login/Register
              </Button>
                 }
